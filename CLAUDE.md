...
* [x] 現代極簡 Design Craft 控制面板 (`popup/popup.html`, `popup.css`, `popup.js`)
  ...
  - [x] 核心開關清單 (純聽音樂模式 + 播放清單真隨機)
  - [x] 優雅收合之進階微調選單 (分段膠囊按鈕調整嚴格度與調音風格)
